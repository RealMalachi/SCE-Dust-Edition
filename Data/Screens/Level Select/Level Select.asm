...
LevelSelect_Controls:
		...
		cmpi.w	#LevelSelect_CharacterCount,d3
		beq.s	LevelSelect_LoadCharacterNumber
...
LevelSelect_LoadCharacterNumber:
		move.w	#LevelSelect_MaxCharacters-1,d2
...
LevelSelect_LoadCharacterText: offsetTable
		offsetTableEntry.w LevelSelect_Player1
		offsetTableEntry.w LevelSelect_Player2
		offsetTableEntry.w LevelSelect_Player3
		offsetTableEntry.w LevelSelect_Player4
...
.copy
	...
	if LevelSelect_VRAM<>0
		...
		cmpi.w	#LevelSelect_CharacterCount,d0
		beq.w	LevelSelect_LoadCharacter
